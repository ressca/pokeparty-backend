...
def test_create_user(db_session):
    # Create a user
    new_user = User(username="testuser_model", email="test_model@example.com", hashed_password="secretpassword")
    ...
    assert new_user.username == "testuser_model"
    assert new_user.email == "test_model@example.com"
